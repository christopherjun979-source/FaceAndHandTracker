...
* **Color-coded:** Separates the wrist base (red), pinky (purple), thumb (orange), index (yellow), middle (green), ring (blue) fingers individually, whilst visually using distinct colors to match the data display with the camera mesh.
